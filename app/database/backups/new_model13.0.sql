...
CREATE TABLE IF NOT EXISTS `gts_db`.`ot_inspec_infras` (
  ...
  `ot_correlativo` VARCHAR(4) NULL,
  `anho_construccion` TIMESTAMP NULL DEFAULT NULL,
...
-- -----------------------------------------------------
-- Table `gts_db`.`tipo_documentosinv`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `gts_db`.`tipo_documentosinv` ;

CREATE TABLE IF NOT EXISTS `gts_db`.`tipo_documentosinv` (
  `idtipo_documentosinv` INT NOT NULL AUTO_INCREMENT,
  `nombre` VARCHAR(100) NULL,
  `descripcion` VARCHAR(200) NULL,
  `created_at` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` TIMESTAMP NULL DEFAULT NULL,
  `deleted_at` TIMESTAMP NULL DEFAULT NULL,
  PRIMARY KEY (`idtipo_documentosinv`))
ENGINE = InnoDB;


-- -----------------------------------------------------
-- Table `gts_db`.`documentosinv`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `gts_db`.`documentosinv` ;

CREATE TABLE IF NOT EXISTS `gts_db`.`documentosinv` (
  `iddocumentosinv` INT NOT NULL AUTO_INCREMENT,
  `nombre` VARCHAR(100) NOT NULL,
  `descripcion` VARCHAR(150) NULL,
  `autor` VARCHAR(100) NOT NULL,
  `codigo_archivamiento` VARCHAR(100) NOT NULL,
  ...
  `nombre_archivo_encriptado` VARCHAR(200) NULL,
  `idestado` INT NOT NULL,
  `idtipo_documentosinv` INT NOT NULL,
  PRIMARY KEY (`iddocumentosinv`),
  INDEX `fk_documentosinv_estados1_idx` (`idestado` ASC),
  INDEX `fk_documentosinv_tipo_documentosinv1_idx` (`idtipo_documentosinv` ASC),
  CONSTRAINT `fk_documentosinv_estados1`
    FOREIGN KEY (`idestado`)
    REFERENCES `gts_db`.`estados` (`idestado`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_documentosinv_tipo_documentosinv1`
    FOREIGN KEY (`idtipo_documentosinv`)
    REFERENCES `gts_db`.`tipo_documentosinv` (`idtipo_documentosinv`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
