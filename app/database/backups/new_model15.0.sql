...
CREATE TABLE IF NOT EXISTS `gts_db`.`ot_vmetrologicas` (
  ...
  `fecha_conformidad` TIMESTAMP NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `gts_db`.`tareas_ot_preventivos` (
  ...
  INDEX `fk_tareas_ot_preventivos_users1_idx` (`creador` ASC),
  CONSTRAINT `fk_tareas_ot_preventivos_familia_activos1`
    FOREIGN KEY (`idfamilia_activo`)
    REFERENCES `gts_db`.`familia_activos` (`idfamilia_activo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_tareas_ot_preventivos_users1`
    FOREIGN KEY (`creador`)
    REFERENCES `gts_db`.`users` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `gts_db`.`tipo_referencia` (
  `idtipo_referencia` INT NOT NULL AUTO_INCREMENT,
  `nombre` VARCHAR(100) NOT NULL,
  `created_at` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS `gts_db`.`cotizaciones` (
  ...
  `updated_at` TIMESTAMP NULL,
  `deleted_at` TIMESTAMP NULL DEFAULT NULL,
  `idtipo_referencia` INT NOT NULL,
  `codigo_cotizacion` VARCHAR(45) NULL,
  `enlace_seace` VARCHAR(200) NULL,
  `modelo_equipo` VARCHAR(100) NULL,
  `nombre_detallado` VARCHAR(100) NULL,
  ...
  INDEX `fk_cotizaciones_tipo_referencia1_idx` (`idtipo_referencia` ASC),
...
CREATE TABLE IF NOT EXISTS `gts_db`.`ot_correctivos` (
  ...
  `nombre_ejecutor` VARCHAR(200) NULL,
  `fecha_inicio_ejecucion` TIMESTAMP NULL DEFAULT NULL,
  `fecha_termino_ejecucion` TIMESTAMP NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `gts_db`.`ot_preventivos` (
  ...
  `fecha_termino_ejecucion` TIMESTAMP NULL DEFAULT NULL,
  `sin_interrupcion_servicio` INT NULL DEFAULT NULL,
  `created_at` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` TIMESTAMP NULL DEFAULT NULL,
  `deleted_at` TIMESTAMP NULL DEFAULT NULL,
  `nombre_ejecutor` VARCHAR(200) NULL,
...
CREATE TABLE IF NOT EXISTS `gts_db`.`tareas_inspec_equipos` (
  ...
  INDEX `fk_tareas_inspec_equipos_users1_idx` (`creador` ASC),
...
CREATE TABLE IF NOT EXISTS `gts_db`.`estado_programacion_reportes` (
  `idestado_programacion_reportes` INT NOT NULL AUTO_INCREMENT,
  `nombre` VARCHAR(45) NULL,
...
CREATE TABLE IF NOT EXISTS `gts_db`.`programacion_reporte_cn` (
  `idprogramacion_reporte_cn` INT NOT NULL AUTO_INCREMENT,
  `idarea` INT NOT NULL,
  `idservicio` INT NOT NULL,
  `iduser` INT NOT NULL,
  ...
  `updated_at` TIMESTAMP NULL,
  `deleted_at` TIMESTAMP NULL,
  `idestado_programacion_reportes` INT NOT NULL,
  PRIMARY KEY (`idprogramacion_reporte_cn`),
  INDEX `fk_programacion_reporte_cn_areas1_idx` (`idarea` ASC),
  INDEX `fk_programacion_reporte_cn_servicios1_idx` (`idservicio` ASC),
  INDEX `fk_programacion_reporte_cn_users1_idx` (`iduser` ASC),
  INDEX `fk_programacion_reporte_cn_tipo_reporte_cn1_idx` (`idtipo_reporte_CN` ASC),
  INDEX `fk_programacion_reporte_cn_estado_programacion_reportes1_idx` (`idestado_programacion_reportes` ASC),
...
CREATE TABLE IF NOT EXISTS `gts_db`.`reporte_cn` (
  ...
  `updated_at` TIMESTAMP NULL,
  `deleted_at` TIMESTAMP NULL,
  `idprogramacion_reporte_cn` INT NOT NULL,
  PRIMARY KEY (`idreporte_CN`),
  INDEX `fk_reporte_CN_ot_retiros1_idx` (`idot_retiro` ASC),
  INDEX `fk_reporte_cn_programacion_reporte_cn1_idx` (`idprogramacion_reporte_cn` ASC),
...
CREATE TABLE IF NOT EXISTS `gts_db`.`programacion_reporte_etes` (
  `idprogramacion_reporte_etes` INT NOT NULL AUTO_INCREMENT,
  `nombre_reporte` VARCHAR(100) NULL,
  `fecha` DATE NULL,
  `created_at` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` TIMESTAMP NULL,
  ...
  INDEX `fk_programacion_reporte_etes_users1_idx` (`iduser` ASC),
  INDEX `fk_programacion_reporte_etes_tipo_reporte_etes1_idx` (`idtipo_reporte_ETES` ASC),
  INDEX `fk_programacion_reporte_etes_estado_programacion_reportes1_idx` (`idestado_programacion_reportes` ASC),
...
CREATE TABLE IF NOT EXISTS `gts_db`.`reporte_etes` (
  ...
  `updated_at` TIMESTAMP NULL,
  `deleted_at` TIMESTAMP NULL,
  `idprogramacion_reporte_etes` INT NOT NULL,
  PRIMARY KEY (`idreporte_ETES`),
  INDEX `fk_reporte_etes_programacion_reporte_etes1_idx` (`idprogramacion_reporte_etes` ASC),
...
CREATE TABLE IF NOT EXISTS `gts_db`.`programacion_reporte_paac` (
  `idprogramacion_reporte_paac` INT NOT NULL AUTO_INCREMENT,
  `nombre_reporte` VARCHAR(100) NULL,
  `fecha` DATE NULL,
  `created_at` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` TIMESTAMP NULL,
  ...
  INDEX `fk_programacion_reporte_paac_tipo_reporte_paac1_idx` (`idtipo_reporte_PAAC` ASC),
  INDEX `fk_programacion_reporte_paac_users1_idx` (`iduser` ASC),
  INDEX `fk_programacion_reporte_paac_servicios1_idx` (`idservicio` ASC),
  INDEX `fk_programacion_reporte_paac_areas1_idx` (`idarea` ASC),
  INDEX `fk_programacion_reporte_paac_estado_programacion_reportes1_idx` (`idestado_programacion_reportes` ASC),
...
CREATE TABLE IF NOT EXISTS `gts_db`.`reporte_paac` (
  ...
  `updated_at` TIMESTAMP NULL,
  `deleted_at` TIMESTAMP NULL,
  `idprogramacion_reporte_paac` INT NOT NULL,
  PRIMARY KEY (`idreporte_PAAC`),
  INDEX `fk_reporte_paac_programacion_reporte_paac1_idx` (`idprogramacion_reporte_paac` ASC),
...
CREATE TABLE IF NOT EXISTS `gts_db`.`tipo_documentospaac` (
  `idtipo_documentosPAAC` INT NOT NULL AUTO_INCREMENT,
  `nombre` VARCHAR(100) NULL,
  `created_at` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` TIMESTAMP NULL,
  `deleted_at` TIMESTAMP NULL,
...
CREATE TABLE IF NOT EXISTS `gts_db`.`documentospacc` (
  `iddocumentosPAAC` INT NOT NULL AUTO_INCREMENT,
  `nombre` VARCHAR(100) NOT NULL,
  `url` VARCHAR(200) NULL,
  `nombre_archivo` VARCHAR(200) NULL,
  `nombre_archivo_encriptado` VARCHAR(200) NULL,
  ...
  `updated_at` TIMESTAMP NULL,
  `deleted_at` TIMESTAMP NULL,
  `idtipo_documentosPAAC` INT NOT NULL,
  `anho` INT NULL,
  PRIMARY KEY (`iddocumentosPAAC`),
  INDEX `fk_documentosPAAC_tipo_documentosPAAC1_idx` (`idtipo_documentosPAAC` ASC),
...
CREATE TABLE IF NOT EXISTS `gts_db`.`tipo_documentosplandirector` (
  `idtipo_documentosPlanDirector` INT NOT NULL AUTO_INCREMENT,
  `nombre` VARCHAR(100) NULL,
  `created_at` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` TIMESTAMP NULL,
  `deleted_at` TIMESTAMP NULL,
...
CREATE TABLE IF NOT EXISTS `gts_db`.`documentosplandirector` (
  `iddocumentosPlanDirector` INT NOT NULL AUTO_INCREMENT,
  `nombre` VARCHAR(100) NOT NULL,
  `url` VARCHAR(200) NULL,
  `nombre_archivo` VARCHAR(200) NULL,
  `nombre_archivo_encriptado` VARCHAR(200) NULL,
  ...
  `updated_at` TIMESTAMP NULL,
  `deleted_at` TIMESTAMP NULL,
  `idtipo_documentosPlanDirector` INT NOT NULL,
  `anho` INT NULL,
  PRIMARY KEY (`iddocumentosPlanDirector`),
  INDEX `fk_documentosPAAC_copy1_tipo_documentosPlanDirector1_idx` (`idtipo_documentosPlanDirector` ASC),
...
CREATE TABLE IF NOT EXISTS `gts_db`.`tipo_documentosinf` (
  `idtipo_documentosinf` INT NOT NULL AUTO_INCREMENT,
  `nombre` VARCHAR(100) NULL,
  `descripcion` VARCHAR(200) NULL,
  `created_at` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` TIMESTAMP NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `gts_db`.`documentosinf` (
  `iddocumentosinf` INT NOT NULL AUTO_INCREMENT,
  `nombre` VARCHAR(100) NOT NULL,
  `descripcion` VARCHAR(150) NULL,
  `autor` VARCHAR(100) NOT NULL,
  `codigo_archivamiento` VARCHAR(100) NOT NULL,
  ...
  `nombre_archivo` VARCHAR(200) NULL,
  `nombre_archivo_encriptado` VARCHAR(200) NULL,
  `idtipo_documentosinf` INT NOT NULL,
  `idestado` INT NOT NULL,
  `idfamilia_activo` INT NULL,
  PRIMARY KEY (`iddocumentosinf`),
  INDEX `fk_documentosinf_tipo_documentosinf1_idx` (`idtipo_documentosinf` ASC),
  INDEX `fk_documentosinf_estados1_idx` (`idestado` ASC),
  INDEX `fk_documentosinf_familia_activos1_idx` (`idfamilia_activo` ASC),
  ...
  CONSTRAINT `fk_documentosinf_estados1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_documentosinf_familia_activos1`
    FOREIGN KEY (`idfamilia_activo`)
    REFERENCES `gts_db`.`familia_activos` (`idfamilia_activo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
