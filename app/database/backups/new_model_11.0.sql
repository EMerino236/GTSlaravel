...
CREATE TABLE IF NOT EXISTS `gts_db`.`ot_preventivos` (
  ...
  `costo_total_repuestos` FLOAT NULL,
  `costo_total_personal` FLOAT NULL,
  `aprobacion_jefe_servicio` INT(1) NULL,
  `id_jefe_servicio` INT NULL DEFAULT NULL,
  `aprobacion_jefe_uib` INT(1) NULL,
  `id_jefe_uib` INT NULL DEFAULT NULL,
  `fecha_inicio_ejecucion` TIMESTAMP NULL,
  `fecha_termino_ejecucion` TIMESTAMP NULL,
  `sin_interrupcion_servicio` INT NULL,
  `created_at` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  ...
  INDEX `fk_ot_preventivos_users3_idx` (`id_jefe_servicio` ASC),
  INDEX `fk_ot_preventivos_users4_idx` (`id_jefe_uib` ASC),
  ...
  CONSTRAINT `fk_ot_preventivos_users2`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_ot_preventivos_users3`
    FOREIGN KEY (`id_jefe_servicio`)
    REFERENCES `gts_db`.`users` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_ot_preventivos_users4`
    FOREIGN KEY (`id_jefe_uib`)
    REFERENCES `gts_db`.`users` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
