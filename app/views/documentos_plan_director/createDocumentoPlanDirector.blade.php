...
@section('content')
	<div class="row">
        <div class="col-lg-12">
            <h3 class="page-header">Crear Documento para Plan Director</h3>
        </div>
        <!-- /.col-lg-12 -->
    </div>
	...
	{{ Form::open(array('url'=>'plan_director/submit_create_documento_plan_director', 'role'=>'form', 'files'=>true)) }}
