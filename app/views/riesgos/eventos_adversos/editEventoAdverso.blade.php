...
@section('content')
	...
	{{ Form::open(array('url'=>'eventos_adversos/submit_edit_evento_adverso', 'role'=>'form')) }}
		...
		{{ Form::hidden('cantidad_tipo_implicados',$cantidad_personas,array('id'=>'cantidad_tipo_implicados'))}}
			...
			<div class="panel-body">
				<div class="row">
					<div class="form-group col-md-4 @if($errors->first('nombre_paciente')) has-error has-feedback @endif">
						...
						@else
							{{ Form::text('nombre_paciente',$evento_adverso_info->nombre_paciente,array('class'=>'form-control','placeholder'=>'Nombre del Paciente')) }}
						@endif
					</div>
					<div class="form-group col-md-2 @if($errors->first('tipo_documento')) has-error has-feedback @endif">
						...
						@else
							{{ Form::select('tipo_documento',array(''=>'Seleccione')+ $tipo_documentos,$evento_adverso_info->idtipo_documento,['class' => 'form-control']) }}
						@endif
					...
					<div class="form-group col-md-2 @if($errors->first('numero_documento')) has-error has-feedback @endif">
						...
						@else
							{{ Form::text('numero_documento',$evento_adverso_info->numero_documento,array('class'=>'form-control','placeholder'=>'N° de Documento')) }}
						@endif
					</div>
					<div class="form-group col-md-2 @if($errors->first('edad')) has-error has-feedback @endif">
						...
						@else
							{{ Form::text('edad',$evento_adverso_info->edad,array('class'=>'form-control','placeholder'=>'edad')) }}
						@endif						
					</div>
					<div class="form-group col-md-2 @if($errors->first('sexo')) has-error has-feedback @endif">
						...
						@else
							{{ Form::select('sexo',array(''=>'Seleccione')+ $sexos,$evento_adverso_info->sexo,['class' => 'form-control']) }}
						@endif
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<div class="form-group col-md-12 @if($errors->first('procedimiento')) has-error has-feedback @endif">
					...
					@else
						{{ Form::textarea('procedimiento',$evento_adverso_info->procedimiento,array('class'=>'form-control','maxlength'=>'500','rows'=>5,'style'=>'resize:none;','placeholder'=>'Procedimiento')) }}
					@endif						
				</div>
				<div class="form-group col-md-12 @if($errors->first('diagnostico')) has-error has-feedback @endif">
					...
					@else
						{{ Form::textarea('diagnostico',$evento_adverso_info->diagnostico,array('class'=>'form-control','maxlength'=>'500','rows'=>5,'style'=>'resize:none;','placeholder'=>'Diagnostico')) }}
					@endif						
				</div>	
			</div>
		</div>
			...
			<div class="panel-body">
				<div class="row">
					...
					<div class="col-md-4 @if($errors->first('frecuencia')) has-error has-feedback @endif">
						...
						@else
							{{ Form::select('frecuencia',array(''=>'Seleccione')+ $tipos_frecuencias,$evento_adverso_info->idfrecuencia,['class' => 'form-control']) }}
						@endif
					</div>
			...
			<div class="panel-body">
				<div class="row">
					<div class="form-group col-md-6 @if($errors->first('tipo_danho')) has-error has-feedback @endif">
						...
						@else
							{{ Form::text('tipo_danho',$evento_adverso_info->tipo_danho,['class' => 'form-control']) }}
						@endif
					</div>
					<div class="form-group col-md-6 @if($errors->first('grado_danho')) has-error has-feedback @endif">
						...
						@else
							{{ Form::select('grado_danho',array(''=>'Seleccione')+ $grados_danhos,$evento_adverso_info->idgrado_danho,['class' => 'form-control']) }}
						@endif
					</div>					
				</div>
			</div>
			...
			<div class="panel-body">
				<div class="row">
					<div class="form-group col-md-12 @if($errors->first('impacto_socioeconomico')) has-error has-feedback @endif">
						...
						@else
							{{ Form::textarea('impacto_socioeconomico',$evento_adverso_info->impacto_socioeconomico,array('class'=>'form-control','maxlength'=>'500','rows'=>5,'style'=>'resize:none;','placeholder'=>'Impacto socioeconómico')) }}
						@endif
					</div>				
				</div>
			</div>
			...
			<div class="panel-body">
				<div class="row">					
					...
					<div class="form-group col-md-4 @if($errors->first('disciplina')) has-error has-feedback @endif" id="div_etapa_servicio">
						...
						@else
							{{ Form::text('disciplina',$evento_adverso_info->disciplina,['class' => 'form-control','placeholder'=>'Disciplina/Especialidad']) }}
						@endif						
					</div>
					<div class="form-group col-md-4 @if($errors->first('factor')) has-error has-feedback @endif">
						...
						@else
							{{ Form::select('factor',array(''=>'Seleccione')+ $factores,$evento_adverso_info->idfactor,['class' => 'form-control']) }}
						@endif
					</div>
					<div class="form-group col-md-4 @if($errors->first('proceso')) has-error has-feedback @endif">
						...
						@else
							{{ Form::select('proceso',array(''=>'Seleccione')+ $procesos,$evento_adverso_info->idproceso,['class' => 'form-control']) }}
						@endif						
					</div>			
				</div>
			</div>
			...
			<div class="panel-body">
				<div class="row">						
					<div class="form-group col-md-12 @if($errors->first('danho_bienes')) has-error has-feedback @endif">
						...
						@else
							{{ Form::textarea('danho_bienes',$evento_adverso_info->danho_bienes,array('class'=>'form-control','maxlength'=>'500','rows'=>5,'style'=>'resize:none;')) }}
						@endif
					</div>		
				</div>
			</div>
			...
			<div class="panel-body">
				<div class="row">
					...
					<div class="form-group col-md-12 @if($errors->first('causa')) has-error has-feedback @endif">
						...
						@else
							{{ Form::textarea('causa',$evento_adverso_info->causa,array('class'=>'form-control','maxlength'=>'500','rows'=>5,'style'=>'resize:none;','placeholder'=>'Causas')) }}
						@endif
					</div>	
					<div class="form-group col-md-12 @if($errors->first('medidas')) has-error has-feedback @endif">
						...
						@else
							{{ Form::textarea('medidas',$evento_adverso_info->medidas,array('class'=>'form-control','maxlength'=>'500','rows'=>5,'style'=>'resize:none;','placeholder'=>'Medidas')) }}
						@endif						
					</div>	
				</div>
			</div>
			...
			<div class="panel-body">
				<div class="row">
					<div class="form-group col-md-4 @if($errors->first('codigo_patrimonial')) has-error has-feedback @endif">
						...
						@else
							{{ Form::text('codigo_patrimonial',$activo_info->codigo_patrimonial,array('class'=>'form-control','id'=>'codigo_patrimonial','placeholder'=>'Código Patrimonial')) }}
						@endif
					</div>
			...
			<div class="panel-body">
				<div class="row">
					<div class="form-group col-md-12 @if($errors->first('informacion')) has-error has-feedback @endif">
						...
						@else
							{{ Form::textarea('informacion',$evento_adverso_info->informacion,array('class'=>'form-control','maxlength'=>'500','rows'=>5,'style'=>'resize:none;','placeholder'=>'Características físicas del dispositivo,acciones correctivas, peso del paciente o cualquier condición del paciente que sea relevante.')) }}
						@endif
					</div>	
				</div>
			</div>
			...
			<div class="panel-body">
				<div class="row">
					<div class="form-group col-md-4 @if($errors->first('nombre_reportante')) has-error has-feedback @endif">
						...
						@else
							{{ Form::text('nombre_reportante',$evento_adverso_info->nombre_reportante,array('class'=>'form-control','placeholder'=>'Nombre')) }}
						@endif
					</div>
					<div class="form-group col-md-4 @if($errors->first('profesion')) has-error has-feedback @endif">
						...
						@else
							{{ Form::text('profesion',$evento_adverso_info->profesion,array('class'=>'form-control','placeholder'=>'Profesión o Cargo')) }}
						@endif
					</div>
					<div class="form-group col-md-4 @if($errors->first('direccion')) has-error has-feedback @endif">
						...
						@else
							{{ Form::text('direccion',$evento_adverso_info->direccion,array('class'=>'form-control','placeholder'=>'Dirección')) }}
						@endif
					</div>
					<div class="form-group col-md-4 @if($errors->first('email')) has-error has-feedback @endif">
						...
						@else
							{{ Form::text('email',$evento_adverso_info->email,array('class'=>'form-control','placeholder'=>'E-mail')) }}
						@endif
					</div>			
				</div>
			</div>
