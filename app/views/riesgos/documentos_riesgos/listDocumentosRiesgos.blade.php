...
{{ Form::open(array('url'=>'/documentos_riesgos/search_documento','method'=>'get' ,'role'=>'form', 'id'=>'search-form','class' => 'form-group')) }}
	...
	<div class="container-fluid form-group row">
		<div class="col-md-2 col-md-offset-10">
			<a class="btn btn-primary btn-block" href="{{URL::to('/documentos_riesgos/create_documento')}}">
				...
				<table class="table">
					...
					<tr class="@if($documento_data->deleted_at) bg-danger @endif">
						<td class="text-nowrap">
							<a href="{{URL::to('/documentos_riesgos/view_documento/')}}/{{$documento_data->id}}">{{$documento_data->nombre}}</a>
						</td>	
						...
						@else
							<td class="text-nowrap text-center">
								<a class="btn btn-warning btn-block btn-sm" href="{{URL::to('/documentos_riesgos/edit_documento/')}}/{{$documento_data->id}}">
