...
@section('content')
	...
	{{ Form::open(array('url'=>'documentos_riesgos/submit_create_documento', 'role'=>'form', 'files'=>true)) }}
			...
			<div class="panel-body">
				<div class="row">
					<div class="form-group col-md-4 @if($errors->first('idtipo_documento')) has-error has-feedback @endif">
						...
						{{ Form::select('idtipo_documento',array(''=>'Seleccione')+ $tipo_documentos,Input::old('idtipo_documento'),['class' => 'form-control']) }}
					</div>
				</div>
				<div class="row">
