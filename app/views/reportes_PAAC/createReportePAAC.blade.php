			...
			<div class="panel-body">
				<div class="row">
					<div class="form-group col-md-4 @if($errors->first('idprogramacion_reporte_paac')) has-error has-feedback @endif">
						{{ Form::label('idprogramacion_reporte_paac','Programaciones No Concluidas') }}<span style='color:red'>*</span>
				...
				<div class="row">
					<div class="form-group col-md-8">
						@if(!$programaciones_reporte_paac)
							<span style='color:red'>No existen Reportes PAAC programados. </span><a href="{{URL::to('/programacion_reportes/create_programacion_reportes')}}"><span style='color:red'><u>Agregar Programación aquí.</u></span></a>						
						@endif
					</div>
				</div>
				<div class="row">
