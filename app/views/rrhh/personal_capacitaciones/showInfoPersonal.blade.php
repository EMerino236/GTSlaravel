...
@section('content')
	...
	<div class="container-fluid row">
		<div class="form-group col-md-2">				
			<a class="btn btn-default btn-primary" style="width:145px" href="{{URL::to('/capacitacion/edit_info_personal')}}/{{$personal->id}}"> <span class="glyphicon glyphicon-floppy-disk"></span> Editar</a>				
		</div>
		<div class="form-group col-md-2  col-md-offset-8">
			<a class="btn btn-default btn-block" style="width:145px" href="{{URL::to('/capacitacion/show_personal')}}/{{$id_capacitacion}}">Regresar</a>				
		</div>
	</div>
	{{ Form::close() }}
