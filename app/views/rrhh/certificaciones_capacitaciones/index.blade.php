...
@section('content')
	...
	<div class="row">
        <div class="col-lg-12">
            <h3 class="page-header">Certificado y Asistencia</h3>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    ...
    {{ Form::open(array('route'=>'certificacion.search','method'=>'get' ,'role'=>'form', 'id'=>'search-form','class' => 'form-group')) }}	
				...
				<table class="table">
					...
					<tr class="@if($capacitacion->deleted_at) bg-danger @endif">			
						<td class="text-nowrap">
							<a href="{{route('certificacion.showCapacitacion',$capacitacion->id)}}">{{$capacitacion->codigo}}</a>
						</td>	
						<td class="text-nowrap">
							{{$capacitacion->nombre}}
						</td>
						...
						<td class="text-nowrap">
							<a class="btn btn-info btn-block btn-sm" style="width:135px;" href="{{URL::to('/certificacion/show_personal/')}}/{{$capacitacion->id}}">
