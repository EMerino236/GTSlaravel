...
@section('content')
	...
	{{ Form::open(array('route'=>['rh_plan_aprendizaje.actividad.update',$actividad->id], 'role'=>'form','files'=>true)) }}
		...
		<div class="row">
			...
			<div class="form-group col-md-2">
				<a class="btn-under" href="{{route('rh_plan_aprendizaje.actividad.destroy',$actividad->id)}}">
					{{ Form::button('<span class="glyphicon glyphicon-circle-arrow-down"></span> Eliminar', array('class' => 'btn btn-danger btn-block')) }}
				</a>
			</div>

			<div class="form-group col-md-2 col-md-offset-6">
				<a class="btn-under" href="{{route('rh_plan_aprendizaje.edit',$actividad->id_plan)}}">
