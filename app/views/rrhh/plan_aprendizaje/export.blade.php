<html>
	...
	<body>
		<div class="nombre_general">
			...
			<h2 id="titulo" >Guia de Aprendizaje - Proyecto: {{$plan->nombre}}</h2>
		</div>
		...
		<ul class="lista_generales">
			...
			<li><label><strong>N° Horas: </strong></label>{{$plan->num_horas}}</li>
			<li><label><strong>Fecha Inicio: </strong></label>{{$plan->fecha_ini}}</li>
			<li><label><strong>Fecha Final: </strong></label>{{$plan->fecha_fin}}</li>
		</ul>
