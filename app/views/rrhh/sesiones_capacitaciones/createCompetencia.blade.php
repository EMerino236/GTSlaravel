...
@section('content')
	<div class="row">
        <div class="col-lg-12">
            <h3 class="page-header">Crear Nueva Competencia</h3>
        </div>
        <!-- /.col-lg-12 -->
    </div>
	...
	{{ Form::open(array('route'=>'capacitacion.store_competencia', 'role'=>'form','files'=>'true')) }}		
	  	...
	  	<div class="panel-body">	
			<div class="form-group row">
				...
				<div class="col-md-6 @if($errors->first('indicador')) has-error has-feedback @endif">
					...
					{{ Form::text('indicador',Input::old('indicador'),['class' => 'form-control'])}}	
				</div>
			</div>
