...
@section('content')
	<div class="row">
        <div class="col-lg-12">
            <h3 class="page-header">Editar Actividad</h3>
        </div>
        <!-- /.col-lg-12 -->
    </div>
	...
	{{ Form::open(array('route'=>'capacitacion.update_actividad', 'role'=>'form','files'=>'true')) }}		
		{{Form::hidden('id_actividad',$actividad->id)}}
	  	...
	  	<div class="panel-body">	
			...
			<div class="form-group row">				
				<div class="col-md-12 @if($errors->first('descripcion')) has-error has-feedback @endif">
					...
					{{ Form::textarea('descripcion',$actividad->descripcion,['class' => 'form-control','style'=>'resize:none','rows'=>'5'])}}	
				</div>
			</div>
			<div class="form-group row">				
				<div class="form-group col-md-4 @if($errors->first('servicio_clinico')) has-error has-feedback @endif">
					{{ Form::label('servicio_clinico','Servicio Clínico') }}
					{{ Form::select('servicio_clinico', array('' => 'Seleccione') + $servicios, $actividad->id_servicio, ['id'=>'servicio_clinico','class'=>'form-control']) }}
				</div>						
	...
	<div class="container-fluid row">
		...
		<div class="form-group col-md-2 col-md-offset-8">
			<a class="btn btn-default btn-block" style="width:145px" href="{{URL::to('/capacitacion/show_actividades')}}/{{$actividad->id_sesion}}">Cancelar</a>				
		</div>
	</div>
	{{ Form::close() }}
