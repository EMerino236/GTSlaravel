...
@section('content')
			  	...
			  	<div class="panel-body">	
					<div class="row">
						...
						<div class="form-group col-md-6">
							...
							{{ Form::text('numero_sesion', $sesiones[$programacion->id_sesion],['id'=>'numero_sesion','class'=>'form-control','readonly'])}}
						</div>
					</div>
	...
	<div class="row">
		<div class="form-group col-md-2">
			<a href="{{route('programacion_docente.edit',$programacion->id)}}">
		...
		<div class="form-group col-md-2 col-md-offset-8">
			<a class="btn btn-default btn-block" href="{{route('programacion_docente.index')}}">Regresar</a>				
		</div>
	</div>
