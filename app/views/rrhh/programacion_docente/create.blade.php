				  	...
				  	<div class="panel-body">	
						<div class="row">
							<div class="form-group col-md-6">
								...
								{{ Form::number('id_capacitacion', Input::old('id_capacitacion'), ['class'=>'form-control']) }}
							</div>
						...
						<div class="row">
							...
							<div class="form-group col-md-6 @if($errors->first('numero_sesion')) has-error has-feedback @endif">
								...
								{{ Form::select('numero_sesion', [0=>'Seleccione'], Input::old('numero_sesion'),['id'=>'numero_sesion','class'=>'form-control'])}}
							</div>
						</div>
