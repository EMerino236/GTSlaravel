				  				...
				  				<div class="table-responsive">
						  			<table class="table">
						  				...
						  				<tr>
						  					...
						  					<td class="text-nowrap">{{$activo_servicio->codigo_patrimonial}}</td>
						  					<td class="text-nowrap">{{$activo_servicio->modelo->familiaActivo->nombre_equipo}}</td>
						  					<td class="text-nowrap">{{$activo_servicio->modelo->familiaActivo->marca->nombre}}</td>
						  					<td class="text-nowrap">{{$activo_servicio->modelo->nombre}}</td>
						  					<td class="text-nowrap">{{$activo_servicio->numero_serie}}</td>
						  				</tr>
						  				@endforeach
					  				</table>
				  				</div>
