<html>
	...
	<body>
		...
		<div>
			<h3>Compras INMP</h3>
			<table style="width:100%"><tr><th>Código de Compra</th><th>Marca</th><th>Modelo</th><th>Proveedor</th><th>Enlace</th><th>{{$anho_actual-5}}</th><th>{{$anho_actual-4}}</th><th>{{$anho_actual-3}}</th><th>{{$anho_actual-2}}</th><th>{{$anho_actual-1}}</th><th>{{$anho_actual}}</th></tr>
