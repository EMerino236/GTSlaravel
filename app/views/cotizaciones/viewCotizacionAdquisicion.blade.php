...
{{ Form::open(array('url'=>'/cotizaciones/search_cotizacion_adquisicion','method'=>'get' ,'role'=>'form', 'id'=>'search-form','class' => 'form-group')) }}
	...
	{{Form::open(array('url'=>'cotizaciones/export_pdf_adquisicion', 'role'=>'form'))}}		
	...
	{{ Form::close() }}
	<div class="form-group col-md-2">
		<a class="btn btn-default btn-block" href="{{URL::to('/cotizaciones/list_cotizacion_adquisicion')}}">Cancelar</a>				
	</div>
@stop