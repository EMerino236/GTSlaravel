...
<div class="alert alert-danger" role="alert">
	...
	@foreach($activos_info as $index => $activo)
		<p><strong>{{ $errors->first('archivo'.$index) }}</strong></p>
		<p><strong>{{ $errors->first('observaciones_equipo'.$index) }}</strong></p>
	@endforeach	
</div>
@endif
...
@endif
	...
	{{ Form::open(array('url'=>'inspec_equipos/submit_create_ot', 'role'=>'form', 'files'=>true, 'id'=>'submit_ot_inspeccion')) }}
				...
				<div id="{{$i+1}}" >
					...
					<div class="row">
									...
									@foreach($tareas_activos[$i] as $j => $tarea)
										<tr>
											...
											@if($tarea->idestado_realizado == 23)
												<button class="btn btn-success boton-tarea" data-id="{{$tarea->idot_inspec_equiposxactivosxtareas_inspec_equipo}}" type="button"><span class="glyphicon glyphicon-ok"></span> Marcar Realizada</button>
											@else
												Realizada
											@endif
											</td>
						...
						<div class="col-md-4 form-group">
							...
							<div style="border:solid;width:480px;height:300px;">
