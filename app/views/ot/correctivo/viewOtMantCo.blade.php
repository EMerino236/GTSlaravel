			...
			<div class="panel-body">
				<div class="row">
					<div class="form-group col-md-4 @if($errors->first('prioridades')) has-error has-feedback @endif">
						...
						{{ Form::select('prioridades', $prioridades,$ot_info->idprioridad,['class' => 'form-control','disabled'=>'disabled']) }}
					</div>
				...
				<div class="row">
					<div class="form-group col-md-12 @if($errors->first('descripcion_problema')) has-error has-feedback @endif">
						...
						{{ Form::textarea('descripcion_problema', $ot_info->descripcion_problema,array('class'=>'form-control','maxlength'=>'500','rows'=>3,'readonly'=>'')) }}
					</div>
				</div>
			</div>
		</div>
			...
			<div class="panel-body">
				<div class="row">
					<div class="form-group col-md-4 @if($errors->first('tipo_falla')) has-error has-feedback @endif">
						...
						{{ Form::select('tipo_falla', $tipo_fallas,$ot_info->tipo_falla,array('class'=>'form-control','disabled'=>'disabled')) }}
					</div>
				...
				<div class="row">
					<div class="form-group col-md-12 @if($errors->first('diagnostico_falla')) has-error has-feedback @endif">
						...
						{{ Form::textarea('diagnostico_falla', $ot_info->diagnostico_falla,array('class'=>'form-control','maxlength'=>'500','rows'=>3,'readonly'=>'')) }}
					</div>
				</div>
			</div>
		</div>
