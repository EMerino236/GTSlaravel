...
@section('content')
	...
	@endif
	{{ Form::open(array('url'=>'busqueda_informacion/submit_programacion', 'role'=>'form')) }}
    <div class="row">
    	<div class="col-md-12">
			  	...
			  	<div class="panel-body">	
					...
					<div class="row">
						<div class="form-group col-md-6">
							...
							{{ Form::textarea('descripcion',null,array('class' => 'form-control','placeholder'=>'Descripción de la solicitud')) }}
						</div>
						<div class="form-group col-md-6">
							{{ Form::label('motivo','Motivo') }}<span style="color:red"> *</span>
							{{ Form::textarea('motivo',null,array('class' => 'form-control','placeholder'=>'Motivo de la solicitud')) }}
						</div>
					</div>					
			        <div class="row">
						<div class="form-group col-md-6">
							{{ Form::label('detalle','Detalle')}}<span style="color:red"> *</span>
							{{ Form::textarea('detalle',null,array('class' => 'form-control','placeholder'=>'Detalle de la solicitud')) }}
			            </div>
			        </div>
			    </div>				    
			</div>
