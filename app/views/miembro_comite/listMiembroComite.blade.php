...
@section('content')
	...
	@endif
    {{ Form::open(array('url'=>'/miembro_comite/search_miembro_comite','method'=>'get' ,'role'=>'form', 'id'=>'search-form','class' => 'form-group')) }}
			...
			<div class="search_bar">
				...
				<div class="col-md-12">
					...
					<div class="form-group col-md-2">
						<div class="btn btn-default btn-block" id="btnLlimpiar_criterios_list_miembro_comite"><span class="glyphicon glyphicon-refresh"></span> Limpiar</div>				
					</div>
				</div>
				</div>
			</div>	
		...
		<tr class="@if($expediente_tecnico_data->deleted_at) bg-danger @endif">
			...
			<td class="text-nowrap text-center">
				@if(!($user->id == $expediente_tecnico_data->idresponsable || $user->idrol == 2 || 
					...
					<a disabled class="btn btn-warning btn-block btn-sm" href="{{URL::to('/miembro_comite/edit_miembro_comite/')}}/{{$expediente_tecnico_data->idexpediente_tecnico}}">
				@else
					<a class="btn btn-warning btn-block btn-sm" href="{{URL::to('/miembro_comite/edit_miembro_comite/')}}/{{$expediente_tecnico_data->idexpediente_tecnico}}">
				@endif
