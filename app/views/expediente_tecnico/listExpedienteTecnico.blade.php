...
@section('content')
	<div class="row">
        <div class="col-lg-12">
            <h3 class="page-header">Búsqueda de Expediente Técnico y Económico</h3>            
        </div>
        <!-- /.col-lg-12 -->
    </div>
	...
	@endif
    {{ Form::open(array('url'=>'/expediente_tecnico/search_expediente_tecnico','method'=>'get' ,'role'=>'form', 'id'=>'search-form','class' => 'form-group')) }}
	...
	<div class="container-fluid form-group row">
		<div class="col-md-3 col-md-offset-9">
			<a class="btn btn-primary btn-block" href="{{URL::to('/expediente_tecnico/create_expediente_tecnico')}}">
			<span class="glyphicon glyphicon-plus"></span> Agregar Expediente Técnico</a>
		</div>
	</div>
	<table class="table">
		<tr class="info">
