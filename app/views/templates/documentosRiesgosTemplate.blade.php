...
<head>
	...
	<title>Documentos Riesgos</title>
    ...
    <script src="{{ asset('js/riesgos/documentos_riesgos/list_documentos_riesgos.js') }}"></script>
    <script src="{{ asset('js/riesgos/documentos_riesgos/edit_documento_riesgos.js') }}"></script>
