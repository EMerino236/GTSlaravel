...
<head>
    ...
    <script src="{{ asset('js/riesgos/eventos_adversos/list_eventos_adversos.js') }}"></script>
    <script src="{{ asset('js/riesgos/eventos_adversos/create_evento_adverso.js') }}"></script>
