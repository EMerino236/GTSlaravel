...
@section('content')
	...
	{{ Form::open(array('route'=>['trabajo_cronograma.cronograma.update',$cronograma->id], 'role'=>'form')) }}
			...
			<div class="panel-body">
				...
				<div class="row">
					<div class="form-group col-md-4">
						...
						{{ Form::text('codigo', $cronograma->reporte->proyecto->codigo, ['class'=>'form-control','readonly']) }}
					</div>
				</div>
