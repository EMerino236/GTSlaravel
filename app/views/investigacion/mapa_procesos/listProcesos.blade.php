...
@section('content')
	<div class="row">
        <div class="col-lg-12">
            <h3 class="page-header">Busqueda de Procesos</h3>
        </div>
        <!-- /.col-lg-12 -->
    </div>

{{ Form::open(array('url'=>'/mapa_procesos/search_proceso','method'=>'get' ,'role'=>'form', 'id'=>'search-form','class' => 'form-group')) }}
	...
	<div class="panel panel-default">
	  ...
	  <div class="panel-body">
	    <div class="form-group row">
			<div class="col-xs-4">
				{{ Form::label('search_tipo_documento','Tipo de Proceso') }}				
				{{ Form::select('search_tipo_documento', array('0' => 'Seleccione') + $tipo_documentos,$search_tipo_documento,['class' => 'form-control']) }}
			</div>
			<div class="col-xs-4">
				{{ Form::label('search_autor','Autor de Proceso') }}
				{{ Form::text('search_autor',$search_autor,array('class'=>'form-control','placeholder'=>'Autor de Proceso'))  }}
			</div>
			<div class="col-xs-4">
				{{ Form::label('search_nombre','Nombre de Proceso') }}
				{{ Form::text('search_nombre',$search_nombre,array('class'=>'form-control','placeholder'=>'Nombre de Proceso')) }}
			</div>
		</div>
	...
	<div class="container-fluid form-group row">
		<div class="col-md-2 col-md-offset-10">
			<a class="btn btn-primary btn-block" href="{{URL::to('mapa_procesos/create_proceso')}}">
	...
	<table class="table">
		...
		<tr class="@if($documento_data->deleted_at) bg-danger @endif">
			...
			<td>
				{{ Form::open(array('url'=>'/mapa_procesos/download_proceso','role'=>'form', 'id'=>'search-form','class' => 'form-inline')) }}
	...
	@if($search_tipo_documento || $search_autor || $search_nombre)
		...
		'search_nombre'=> $search_nombre))->links() }}
	@else
