			...
			@foreach($programaciones_reporte_gpc as $programacion_reporte_gpc)
				...
				@if($usuario_responsable_data->iduser == $programacion_reporte_gpc->iduser)
					<tr><th class="info" style="font-weight:normal">{{$programacion_reporte_gpc->nombre_reporte}}</th>
						...
						@if(\Carbon\Carbon::createFromFormat('Y-m-d',$programaciones_reporte_gpc->first()->fecha)->month == 1)
							<th bgcolor='@if($programacion_reporte_gpc->id_estado==2) lightGreen @elseif($programacion_reporte_gpc->id_estado==1) @if($anho_actual<$search_fecha and $search_fecha>0) yellow @elseif($anho_actual>$search_fecha and $search_fecha>0) red @else @if($mes_actual>1) red @elseif ($mes_actual==1) @if (\Carbon\Carbon::createFromFormat('Y-m-d',$programacion_reporte_gpc->fecha)->day>=$dia_actual and \Carbon\Carbon::createFromFormat('Y-m-d',$programacion_reporte_gpc->fecha)->day>0) yellow @elseif (\Carbon\Carbon::createFromFormat('Y-m-d',$programacion_reporte_gpc->fecha)->day>0) red @endif @else lightGreen @endif @endif @endif' style="font-weight:normal">
						...
						@if(\Carbon\Carbon::createFromFormat('Y-m-d',$programaciones_reporte_gpc->first()->fecha)->month == 2)
							<th bgcolor='@if($programacion_reporte_gpc->id_estado==2) lightGreen @elseif($programacion_reporte_gpc->id_estado==1) @if($anho_actual<$search_fecha and $search_fecha>0) yellow @elseif($anho_actual>$search_fecha and $search_fecha>0) red @else @if($mes_actual>2) red @elseif ($mes_actual==2) @if (\Carbon\Carbon::createFromFormat('Y-m-d',$programacion_reporte_gpc->fecha)->day>=$dia_actual and \Carbon\Carbon::createFromFormat('Y-m-d',$programacion_reporte_gpc->fecha)->day>0) yellow @elseif (\Carbon\Carbon::createFromFormat('Y-m-d',$programacion_reporte_gpc->fecha)->day>0) red @endif @else lightGreen @endif @endif @endif' style="font-weight:normal">
							<center><a href="@if($programacion_reporte_gpc->id_estado==2 || ($programacion_reporte_gpc->guia && $programacion_reporte_gpc->guia->url=="")) {{URL::to('/guias_clinica_gpc/edit_guia/')}}/{{$programacion_reporte_gpc->id_guia}} @else {{URL::to('/guias_clinica_gpc/create_guia/')}}/{{$programacion_reporte_gpc->id}} @endif">{{\Carbon\Carbon::createFromFormat('Y-m-d',$programacion_reporte_gpc->fecha)->day}}</a></center></th>
						@else
							<th></th>
						@endif

						@if(\Carbon\Carbon::createFromFormat('Y-m-d',$programaciones_reporte_gpc->first()->fecha)->month == 3)
							<th bgcolor='@if($programacion_reporte_gpc->id_estado==2) lightGreen @elseif($programacion_reporte_gpc->id_estado==1) @if($anho_actual<$search_fecha and $search_fecha>0) yellow @elseif($anho_actual>$search_fecha and $search_fecha>0) red @else @if($mes_actual>3) red @elseif ($mes_actual==3) @if (\Carbon\Carbon::createFromFormat('Y-m-d',$programacion_reporte_gpc->fecha)->day>=$dia_actual and \Carbon\Carbon::createFromFormat('Y-m-d',$programacion_reporte_gpc->fecha)->day>0) yellow @elseif (\Carbon\Carbon::createFromFormat('Y-m-d',$programacion_reporte_gpc->fecha)->day>0) red @endif @else lightGreen @endif @endif @endif' style="font-weight:normal">
							<center><a href="@if($programacion_reporte_gpc->id_estado==2 || ($programacion_reporte_gpc->guia && $programacion_reporte_gpc->guia->url=="")) {{URL::to('/guias_clinica_gpc/edit_guia/')}}/{{$programacion_reporte_gpc->id_guia}} @else {{URL::to('/guias_clinica_gpc/create_guia/')}}/{{$programacion_reporte_gpc->id}} @endif">{{\Carbon\Carbon::createFromFormat('Y-m-d',$programacion_reporte_gpc->fecha)->day}}</a></center></th>
						@else
							<th></th>
						@endif

						@if(\Carbon\Carbon::createFromFormat('Y-m-d',$programaciones_reporte_gpc->first()->fecha)->month == 4)
							<th bgcolor='@if($programacion_reporte_gpc->id_estado==2) lightGreen @elseif($programacion_reporte_gpc->id_estado==1) @if($anho_actual<$search_fecha and $search_fecha>0) yellow @elseif($anho_actual>$search_fecha and $search_fecha>0) red @else @if($mes_actual>4) red @elseif ($mes_actual==4) @if (\Carbon\Carbon::createFromFormat('Y-m-d',$programacion_reporte_gpc->fecha)->day>=$dia_actual and \Carbon\Carbon::createFromFormat('Y-m-d',$programacion_reporte_gpc->fecha)->day>0) yellow @elseif (\Carbon\Carbon::createFromFormat('Y-m-d',$programacion_reporte_gpc->fecha)->day>0) red @endif @else lightGreen @endif @endif @endif' style="font-weight:normal">
							<center><a href="@if($programacion_reporte_gpc->id_estado==2 || ($programacion_reporte_gpc->guia && $programacion_reporte_gpc->guia->url=="")) {{URL::to('/guias_clinica_gpc/edit_guia/')}}/{{$programacion_reporte_gpc->id_guia}} @else {{URL::to('/guias_clinica_gpc/create_guia/')}}/{{$programacion_reporte_gpc->id}} @endif">{{\Carbon\Carbon::createFromFormat('Y-m-d',$programacion_reporte_gpc->fecha)->day}}</a></center></th>
						@else
							<th></th>
						@endif

						@if(\Carbon\Carbon::createFromFormat('Y-m-d',$programaciones_reporte_gpc->first()->fecha)->month == 5)
							<th bgcolor='@if($programacion_reporte_gpc->id_estado==2) lightGreen @elseif($programacion_reporte_gpc->id_estado==1) @if($anho_actual<$search_fecha and $search_fecha>0) yellow @elseif($anho_actual>$search_fecha and $search_fecha>0) red @else @if($mes_actual>5) red @elseif ($mes_actual==5) @if (\Carbon\Carbon::createFromFormat('Y-m-d',$programacion_reporte_gpc->fecha)->day>=$dia_actual and \Carbon\Carbon::createFromFormat('Y-m-d',$programacion_reporte_gpc->fecha)->day>0) yellow @elseif (\Carbon\Carbon::createFromFormat('Y-m-d',$programacion_reporte_gpc->fecha)->day>0) red @endif @else lightGreen @endif @endif @endif' style="font-weight:normal">
							<center><a href="@if($programacion_reporte_gpc->id_estado==2 || ($programacion_reporte_gpc->guia && $programacion_reporte_gpc->guia->url=="")) {{URL::to('/guias_clinica_gpc/edit_guia/')}}/{{$programacion_reporte_gpc->id_guia}} @else {{URL::to('/guias_clinica_gpc/create_guia/')}}/{{$programacion_reporte_gpc->id}} @endif">{{\Carbon\Carbon::createFromFormat('Y-m-d',$programacion_reporte_gpc->fecha)->day}}</a></center></th>
						@else
							<th></th>
						@endif

						@if(\Carbon\Carbon::createFromFormat('Y-m-d',$programaciones_reporte_gpc->first()->fecha)->month == 6)
							<th bgcolor='@if($programacion_reporte_gpc->id_estado==2) lightGreen @elseif($programacion_reporte_gpc->id_estado==1) @if($anho_actual<$search_fecha and $search_fecha>0) yellow @elseif($anho_actual>$search_fecha and $search_fecha>0) red @else @if($mes_actual>6) red @elseif ($mes_actual==6) @if (\Carbon\Carbon::createFromFormat('Y-m-d',$programacion_reporte_gpc->fecha)->day>=$dia_actual and \Carbon\Carbon::createFromFormat('Y-m-d',$programacion_reporte_gpc->fecha)->day>0) yellow @elseif (\Carbon\Carbon::createFromFormat('Y-m-d',$programacion_reporte_gpc->fecha)->day>0) red @endif @else lightGreen @endif @endif @endif' style="font-weight:normal">
							<center><a href="@if($programacion_reporte_gpc->id_estado==2 || ($programacion_reporte_gpc->guia && $programacion_reporte_gpc->guia->url=="")) {{URL::to('/guias_clinica_gpc/edit_guia/')}}/{{$programacion_reporte_gpc->id_guia}} @else {{URL::to('/guias_clinica_gpc/create_guia/')}}/{{$programacion_reporte_gpc->id}} @endif">{{\Carbon\Carbon::createFromFormat('Y-m-d',$programacion_reporte_gpc->fecha)->day}}</a></center></th>
						@else
							<th></th>
						@endif

						@if(\Carbon\Carbon::createFromFormat('Y-m-d',$programaciones_reporte_gpc->first()->fecha)->month == 7)
							<th bgcolor='@if($programacion_reporte_gpc->id_estado==2) lightGreen @elseif($programacion_reporte_gpc->id_estado==1) @if($anho_actual<$search_fecha and $search_fecha>0) yellow @elseif($anho_actual>$search_fecha and $search_fecha>0) red @else @if($mes_actual>7) red @elseif ($mes_actual==7) @if (\Carbon\Carbon::createFromFormat('Y-m-d',$programacion_reporte_gpc->fecha)->day>=$dia_actual and \Carbon\Carbon::createFromFormat('Y-m-d',$programacion_reporte_gpc->fecha)->day>0) yellow @elseif (\Carbon\Carbon::createFromFormat('Y-m-d',$programacion_reporte_gpc->fecha)->day>0) red @endif @else lightGreen @endif @endif @endif' style="font-weight:normal">
							<center><a href="@if($programacion_reporte_gpc->id_estado==2 || ($programacion_reporte_gpc->guia && $programacion_reporte_gpc->guia->url=="")) {{URL::to('/guias_clinica_gpc/edit_guia/')}}/{{$programacion_reporte_gpc->id_guia}} @else {{URL::to('/guias_clinica_gpc/create_guia/')}}/{{$programacion_reporte_gpc->id}} @endif">{{\Carbon\Carbon::createFromFormat('Y-m-d',$programacion_reporte_gpc->fecha)->day}}</a></center></th>
						@else
							<th></th>
						@endif

						@if(\Carbon\Carbon::createFromFormat('Y-m-d',$programaciones_reporte_gpc->first()->fecha)->month == 8)
							<th bgcolor='@if($programacion_reporte_gpc->id_estado==2) lightGreen @elseif($programacion_reporte_gpc->id_estado==1) @if($anho_actual<$search_fecha and $search_fecha>0) yellow @elseif($anho_actual>$search_fecha and $search_fecha>0) red @else @if($mes_actual>8) red @elseif ($mes_actual==8) @if (\Carbon\Carbon::createFromFormat('Y-m-d',$programacion_reporte_gpc->fecha)->day>=$dia_actual and \Carbon\Carbon::createFromFormat('Y-m-d',$programacion_reporte_gpc->fecha)->day>0) yellow @elseif (\Carbon\Carbon::createFromFormat('Y-m-d',$programacion_reporte_gpc->fecha)->day>0) red @endif @else lightGreen @endif @endif @endif' style="font-weight:normal">
							<center><a href="@if($programacion_reporte_gpc->id_estado==2 || ($programacion_reporte_gpc->guia && $programacion_reporte_gpc->guia->url=="")) {{URL::to('/guias_clinica_gpc/edit_guia/')}}/{{$programacion_reporte_gpc->id_guia}} @else {{URL::to('/guias_clinica_gpc/create_guia/')}}/{{$programacion_reporte_gpc->id}} @endif">{{\Carbon\Carbon::createFromFormat('Y-m-d',$programacion_reporte_gpc->fecha)->day}}</a></center></th>
						@else
							<th></th>
						@endif

						@if(\Carbon\Carbon::createFromFormat('Y-m-d',$programaciones_reporte_gpc->first()->fecha)->month == 9)
							<th bgcolor='@if($programacion_reporte_gpc->id_estado==2) lightGreen @elseif($programacion_reporte_gpc->id_estado==1) @if($anho_actual<$search_fecha and $search_fecha>0) yellow @elseif($anho_actual>$search_fecha and $search_fecha>0) red @else @if($mes_actual>9) red @elseif ($mes_actual==9) @if (\Carbon\Carbon::createFromFormat('Y-m-d',$programacion_reporte_gpc->fecha)->day>=$dia_actual and \Carbon\Carbon::createFromFormat('Y-m-d',$programacion_reporte_gpc->fecha)->day>0) yellow @elseif (\Carbon\Carbon::createFromFormat('Y-m-d',$programacion_reporte_gpc->fecha)->day>0) red @endif @else lightGreen @endif @endif @endif' style="font-weight:normal">
							<center><a href="@if($programacion_reporte_gpc->id_estado==2 || ($programacion_reporte_gpc->guia && $programacion_reporte_gpc->guia->url=="")) {{URL::to('/guias_clinica_gpc/edit_guia/')}}/{{$programacion_reporte_gpc->id_guia}} @else {{URL::to('/guias_clinica_gpc/create_guia/')}}/{{$programacion_reporte_gpc->id}} @endif">{{\Carbon\Carbon::createFromFormat('Y-m-d',$programacion_reporte_gpc->fecha)->day}}</a></center></th>
						@else
							<th></th>
						@endif

						@if(\Carbon\Carbon::createFromFormat('Y-m-d',$programaciones_reporte_gpc->first()->fecha)->month == 10)
							<th bgcolor='@if($programacion_reporte_gpc->id_estado==2) lightGreen @elseif($programacion_reporte_gpc->id_estado==1) @if($anho_actual<$search_fecha and $search_fecha>0) yellow @elseif($anho_actual>$search_fecha and $search_fecha>0) red @else @if($mes_actual>10) red @elseif ($mes_actual==10) @if (\Carbon\Carbon::createFromFormat('Y-m-d',$programacion_reporte_gpc->fecha)->day>=$dia_actual and \Carbon\Carbon::createFromFormat('Y-m-d',$programacion_reporte_gpc->fecha)->day>0) yellow @elseif (\Carbon\Carbon::createFromFormat('Y-m-d',$programacion_reporte_gpc->fecha)->day>0) red @endif @else lightGreen @endif @endif @endif' style="font-weight:normal">
							<center><a href="@if($programacion_reporte_gpc->id_estado==2 || ($programacion_reporte_gpc->guia && $programacion_reporte_gpc->guia->url=="")) {{URL::to('/guias_clinica_gpc/edit_guia/')}}/{{$programacion_reporte_gpc->id_guia}} @else {{URL::to('/guias_clinica_gpc/create_guia/')}}/{{$programacion_reporte_gpc->id}} @endif">{{\Carbon\Carbon::createFromFormat('Y-m-d',$programacion_reporte_gpc->fecha)->day}}</a></center></th>
						@else
							<th></th>
						@endif

						@if(\Carbon\Carbon::createFromFormat('Y-m-d',$programaciones_reporte_gpc->first()->fecha)->month == 11)
							<th bgcolor='@if($programacion_reporte_gpc->id_estado==2) lightGreen @elseif($programacion_reporte_gpc->id_estado==1) @if($anho_actual<$search_fecha and $search_fecha>0) yellow @elseif($anho_actual>$search_fecha and $search_fecha>0) red @else @if($mes_actual>11) red @elseif ($mes_actual==11) @if (\Carbon\Carbon::createFromFormat('Y-m-d',$programacion_reporte_gpc->fecha)->day>=$dia_actual and \Carbon\Carbon::createFromFormat('Y-m-d',$programacion_reporte_gpc->fecha)->day>0) yellow @elseif (\Carbon\Carbon::createFromFormat('Y-m-d',$programacion_reporte_gpc->fecha)->day>0) red @endif @else lightGreen @endif @endif @endif' style="font-weight:normal">
							<center><a href="@if($programacion_reporte_gpc->id_estado==2 || ($programacion_reporte_gpc->guia && $programacion_reporte_gpc->guia->url=="")) {{URL::to('/guias_clinica_gpc/edit_guia/')}}/{{$programacion_reporte_gpc->id_guia}} @else {{URL::to('/guias_clinica_gpc/create_guia/')}}/{{$programacion_reporte_gpc->id}} @endif">{{\Carbon\Carbon::createFromFormat('Y-m-d',$programacion_reporte_gpc->fecha)->day}}</a></center></th>
						@else
							<th></th>
						@endif

						@if(\Carbon\Carbon::createFromFormat('Y-m-d',$programaciones_reporte_gpc->first()->fecha)->month == 12)
							<th bgcolor='@if($programacion_reporte_gpc->id_estado==2) lightGreen @elseif($programacion_reporte_gpc->id_estado==1) @if($anho_actual<$search_fecha and $search_fecha>0) yellow @elseif($anho_actual>$search_fecha and $search_fecha>0) red @else @if($mes_actual>12) red @elseif ($mes_actual==12) @if (\Carbon\Carbon::createFromFormat('Y-m-d',$programacion_reporte_gpc->fecha)->day>=$dia_actual and \Carbon\Carbon::createFromFormat('Y-m-d',$programacion_reporte_gpc->fecha)->day>0) yellow @elseif (\Carbon\Carbon::createFromFormat('Y-m-d',$programacion_reporte_gpc->fecha)->day>0) red @endif @else lightGreen @endif @endif @endif' style="font-weight:normal">
							<center><a href="@if($programacion_reporte_gpc->id_estado==2 || ($programacion_reporte_gpc->guia && $programacion_reporte_gpc->guia->url=="")) {{URL::to('/guias_clinica_gpc/edit_guia/')}}/{{$programacion_reporte_gpc->id_guia}} @else {{URL::to('/guias_clinica_gpc/create_guia/')}}/{{$programacion_reporte_gpc->id}} @endif">{{\Carbon\Carbon::createFromFormat('Y-m-d',$programacion_reporte_gpc->fecha)->day}}</a></center></th>
						@else
							<th></th>
						@endif
