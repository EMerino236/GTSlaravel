...
@section('content')
	...
	{{ Form::open(array('url'=>'guias_tecno_salud/edit_guia/'.$documento_info->iddocumentosinf, 'role'=>'form', 'files'=>true)) }}
		...
		<div class="container-fluid row">			
			...
			@endif
			<div class="col-md-2 form-group">
				<a class="btn btn-default btn-block" href="{{URL::to('/guias_tecno_salud/list_guias')}}">Cancelar</a>
			</div>	
		{{ Form::close() }}
			@if($documento_info->deleted_at)
			{{ Form::open(array('url'=>'guias_tecno_salud/submit_enable_guia', 'role'=>'form')) }}
				{{ Form::hidden('documento_id', $documento_info->iddocumentosinf) }}
			...
			{{ Form::close() }}
			@else
			{{ Form::open(array('url'=>'guias_tecno_salud/submit_disable_guia', 'role'=>'form')) }}
				{{ Form::hidden('documento_id', $documento_info->iddocumentosinf) }}
