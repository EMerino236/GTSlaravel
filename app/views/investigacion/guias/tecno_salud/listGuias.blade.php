...
@section('content')
	<div class="row">
        <div class="col-lg-12">
            <h3 class="page-header">Búsqueda de Guías de Tecnologías de Salud</h3>
        </div>
        <!-- /.col-lg-12 -->
    </div>

{{ Form::open(array('url'=>'/guias_tecno_salud/search_guia','method'=>'get' ,'role'=>'form', 'id'=>'search-form','class' => 'form-group')) }}
	...
	<div class="container-fluid form-group row">
		<div class="col-md-2 col-md-offset-10">
			<a class="btn btn-primary btn-block" href="{{URL::to('guias_tecno_salud/create_guia')}}">
	...
	<table class="table">
		...
		<tr class="@if($documento_data->deleted_at) bg-danger @endif">
			...
			<td>
				{{ Form::open(array('url'=>'/guias_tecno_salud/download_guia','role'=>'form', 'id'=>'search-form','class' => 'form-inline')) }}
