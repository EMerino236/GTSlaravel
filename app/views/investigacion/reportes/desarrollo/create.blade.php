...
@section('content')
	...
	{{ Form::open(array('route'=>'reporte_desarrollo.store', 'role'=>'form','id'=>'form')) }}
			...
			<div class="panel-body">
				<div class="row">
					...
					<div class="form-group col-md-2">
						...
						{{ Form::button('<span class="glyphicon glyphicon-check"></span> Validar', array('id'=>'submit_create', 'class' => 'btn btn-primary btn-block','onClick'=>'validarReporteDesarrollo()')) }}
					</div>
				</div>
