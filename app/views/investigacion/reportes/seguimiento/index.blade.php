...
@section('content')
	<div class="row">
        <div class="col-lg-12">
            <h3 class="page-header">Reporte de seguimiento y control</h3>
        </div>
        <!-- /.col-lg-12 -->
    </div>

{{ Form::open(array('route'=>'reporte_seguimiento.search','method'=>'get','class' => 'form-group')) }}
	...
	<div class="container-fluid form-group row">
		<div class="col-md-2 col-md-offset-10">
			<a class="btn btn-primary btn-block" href="{{route('reporte_seguimiento.create')}}">
	...
	<div class="row">
		<div class="col-md-12">
			<table class="table">
				<tr class="info">
					<th>Reporte de seg y control</th>
					...
					<th colspan="2" class="text-center">Cronograma</th>
				</tr>
				@foreach($reportes_data as $reporte_data)
				<tr class="@if($reporte_data->deleted_at) bg-danger @endif">
					<td>
						<a href="{{route('reporte_seguimiento.show',$reporte_data->id)}}">
							{{$reporte_data->codigo}}
						</a>
					</td>
					...
					<td class="text-nowrap text-center">
						@if(!$reporte_data->id_cronograma)
							<a class="btn-under" href="{{route('trabajo_cronograma.create',$reporte_data->id)}}">
								{{ Form::button('<span class="glyphicon glyphicon-plus"></span> Crear', ['class' => 'btn btn-success btn-block']) }}
							</a>
						@else
							<a class="btn-under" href="{{route('trabajo_cronograma.show',$reporte_data->id_cronograma)}}">
					...
					<td class="text-nowrap text-center">
						@if($reporte_data->id_cronograma)
							<a class="btn-under" href="{{route('trabajo_cronograma.cronograma.edit',$reporte_data->id_cronograma)}}">
