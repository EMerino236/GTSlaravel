...
@section('content')
	...
	{{ Form::open(array('route'=>['informacion_economica.update',$presupuesto->id], 'role'=>'form')) }}
				  	...
				  	<div class="panel-body">
				  		<div class="row form-group">
					  		<div class="col-md-4">
								...
								{{ Form::text('rh_inversion', $rh_inversion, ['id'=>'rh_inversion','class'=>'form-control','readonly']) }}
					  		</div>
				  		</div>
				  		<div class="row form-group">
							<div class="form-group col-md-4 @if($errors->first('rh_actividades')) has-error has-feedback @endif">
								...
								{{ Form::select('rh_actividad', $rh_actividades,null, ['class'=>'form-control']) }}
							</div>
							<div class="form-group col-md-4 @if($errors->first('rh_actividades')) has-error has-feedback @endif">
				  	...
				  	<div class="panel-body">
				  		<div class="row form-group">
					  		<div class="col-md-4">
								...
								{{ Form::text('eq_inversion', $eq_inversion, ['id'=>'eq_inversion','class'=>'form-control','readonly']) }}
					  		</div>
				  		</div>
				  		<div class="row form-group">
							<div class="form-group col-md-4 @if($errors->first('eq_actividades')) has-error has-feedback @endif">
								...
								{{ Form::select('eq_actividad', $eq_actividades,null, ['class'=>'form-control']) }}
							</div>
							<div class="form-group col-md-4 @if($errors->first('eq_actividades')) has-error has-feedback @endif">
				  	...
				  	<div class="panel-body">
				  		<div class="row form-group">
					  		<div class="col-md-4">
								...
								{{ Form::text('go_inversion', $go_inversion, ['id'=>'go_inversion','class'=>'form-control','readonly']) }}
					  		</div>
				  		</div>
				  		<div class="row form-group">
							<div class="form-group col-md-4 @if($errors->first('go_actividades')) has-error has-feedback @endif">
								...
								{{ Form::select('go_actividad', $go_actividades,null, ['class'=>'form-control']) }}
							</div>
							<div class="form-group col-md-4 @if($errors->first('go_actividades')) has-error has-feedback @endif">
				  	...
				  	<div class="panel-body">
				  		<div class="row form-group">
					  		<div class="col-md-4">
								...
								{{ Form::text('ga_inversion', $ga_inversion, ['id'=>'ga_inversion','class'=>'form-control','readonly']) }}
					  		</div>
				  		</div>
				  		<div class="row form-group">
							<div class="form-group col-md-4 @if($errors->first('ga_actividades')) has-error has-feedback @endif">
								...
								{{ Form::select('ga_actividad', $ga_actividades, null, ['class'=>'form-control']) }}
							</div>
							<div class="form-group col-md-4 @if($errors->first('ga_actividades')) has-error has-feedback @endif">
		...
		<div class="row">
			...
			<div class="form-group col-md-2">
				<a class="btn-under" href="{{route('informacion_economica.show',$presupuesto->id_proyecto)}}">
