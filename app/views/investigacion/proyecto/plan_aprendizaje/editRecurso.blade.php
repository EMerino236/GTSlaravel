...
@section('content')
	...
	{{ Form::open(array('route'=>['plan_aprendizaje.recurso.update',$recurso->id], 'role'=>'form','files'=>true)) }}
		...
		<div class="row">
			...
			<div class="form-group col-md-2">
				<a class="btn-under" href="{{route('plan_aprendizaje.recurso.destroy',$recurso->id)}}">
					{{ Form::button('<span class="glyphicon glyphicon-circle-arrow-down"></span> Eliminar', array('class' => 'btn btn-danger btn-block')) }}
				</a>
			</div>

			<div class="form-group col-md-2 col-md-offset-6">
				<a class="btn-under" href="{{route('plan_aprendizaje.edit',$recurso->id_plan)}}">
