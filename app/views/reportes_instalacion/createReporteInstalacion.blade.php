    ...
    {{ Form::open(array('url'=>'/rep_instalacion/submit_create_rep_instalacion','role'=>'form')) }}
  			...
  			<div class="panel-body">
				<div class="col-xs-6">
					<div class="form-group row">
						<div class="form-group col-xs-8 @if($errors->first('idtipo_reporte_instalacion')) has-error has-feedback @endif">
					...
					<div class="form-group row">
						<div class="form-group col-xs-8 @if($errors->first('numero_reporte')) has-error has-feedback @endif">
							{{ Form::label('numero_reporte','Número de Reporte') }}
							{{ Form::text('numero_reporte',Input::old('numero_reporte'),array('class'=>'form-control')) }}
						</div>
					</div>						
					<div class="form-group row">
						<div class="form-group col-xs-8 @if($errors->first('idproveedor')) has-error has-feedback @endif">
					...
					<div class="form-group row">
						...
						<div id="datetimepicker1" class="form-group input-group date col-xs-8 @if($errors->first('fecha')) has-error has-feedback @endif">
				...
				<div class="col-xs-6">
					...
					<div class="form-group row">
						<div class="form-group col-xs-8 @if($errors->first('codigo_compra')) has-error has-feedback @endif">
		...
		<div class="panel panel-default">
  			...
  			<div class="panel-body">
  				<div class="col-xs-6">
					<div class="form-group row">
						<div class="form-group col-xs-10 @if($errors->first('nombre_tarea')) has-error has-feedback @endif">
				...
				<div class="col-xs-6">
					<div class="form-group row">
						<div class="form-group col-xs-6 @if($errors->first('tarea_realizada')) has-error has-feedback @endif">
		...
		<div class="panel panel-default">
  			...
  			<div class="panel-body">
  				<div class="row">
					<div class="form-group col-xs-2 @if($errors->first('numero_documento1')) has-error has-feedback @endif">
					...
					<div class="form-group col-xs-1" style="margin-top:25px">
						<a class="btn btn-default" onclick="llenar_nombre_responsable(1)">Agregar</a>
					</div>
					<div class="form-group col-xs-1" style="margin-top:25px">
						<a class="btn btn-default" onclick="limpiar_nombre_responsable(1)">Limpiar</a>
					</div>
  		...
  		<div class="row">
			<div class="col-xs-12">
				<div class="panel panel-default" id="panel-documentos-relacionados" hidden>
	  				...
	  				<div class="panel-body">
						<div class="row">
							<div class="form-group col-xs-3 @if($errors->first('numero_reporte_entorno_concluido')) has-error has-feedback @endif">
								{{ Form::label('numero_reporte_entorno_concluido','N° de Reporte Entorno Concluido') }}
							...
							<div class="form-group col-xs-1" style="margin-top:25px">
								<a class="btn btn-default" onclick="validar_num_rep_entorno_concluido()">Agregar</a>
							</div>
							<div class="form-group col-xs-1" style="margin-top:25px; margin-left:15px">
								<a class="btn btn-default" onclick="limpiar_num_rep_entorno_concluido()">Limpiar</a>
							</div>
						...
						<div class="row">
							<div class="form-group col-xs-3 @if($errors->first('num_doc_relacionado1')) has-error has-feedback @endif">
							...
							<div class="form-group col-xs-1" style="margin-top:25px">
								<a class="btn btn-default" onclick="llenar_nombre_doc_relacionado(1)">Agregar</a>
							</div>
							<div class="form-group col-xs-1" style="margin-top:25px; margin-left:15px">
								<a class="btn btn-default" onclick="limpiar_nombre_doc_relacionado(1)">Limpiar</a>
							</div>
							<div class="form-group col-xs-3"  style="margin-left:15px">
						...
						<div class="row">
							<div class="form-group col-xs-3 @if($errors->first('num_doc_relacionado2')) has-error has-feedback @endif">
							...
							<div class="form-group col-xs-1" style="margin-top:25px">
								<a class="btn btn-default" onclick="llenar_nombre_doc_relacionado(2)">Agregar</a>
							</div>
							<div class="form-group col-xs-1" style="margin-top:25px; margin-left:15px">
								<a class="btn btn-default" onclick="limpiar_nombre_doc_relacionado(2)">Limpiar</a>
							</div>
							<div class="form-group col-xs-3"  style="margin-left:15px">
						...
						<div class="row">
							<div class="form-group col-xs-3 @if($errors->first('num_doc_relacionado3')) has-error has-feedback @endif">
							...
							<div class="form-group col-xs-1" style="margin-top:25px">
								<a class="btn btn-default" onclick="llenar_nombre_doc_relacionado(3)">Agregar</a>
							</div>
							<div class="form-group col-xs-1" style="margin-top:25px; margin-left:15px">
								<a class="btn btn-default" onclick="limpiar_nombre_doc_relacionado(3)">Limpiar</a>
							</div>
							<div class="form-group col-xs-3"  style="margin-left:15px">
						...
						<div class="row">
							<div class="form-group col-xs-3 @if($errors->first('num_doc_relacionado4')) has-error has-feedback @endif">
							...
							<div class="form-group col-xs-1" style="margin-top:25px">
								<a class="btn btn-default" onclick="llenar_nombre_doc_relacionado(4)">Agregar</a>
							</div>
							<div class="form-group col-xs-1" style="margin-top:25px; margin-left:15px">
								<a class="btn btn-default" onclick="limpiar_nombre_doc_relacionado(4)">Limpiar</a>
							</div>
							<div class="form-group col-xs-3"  style="margin-left:15px">
